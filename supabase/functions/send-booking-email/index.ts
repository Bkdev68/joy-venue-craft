...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    await sendEmail(adminEmail, `Neue Buchungsanfrage: ${booking.service} - ${booking.eventType}`, adminHtml);
    ...
    try {
      await sendEmail(booking.email, "Ihre Buchungsanfrage bei PixelPalast", customerHtml);
