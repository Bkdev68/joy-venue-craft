...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    const eventRows = [
      ...
      data.duration ? `<tr style="background-color: #f9f9f9;">
    ...
    const contactRows = [
      ...
      data.companyName ? `<tr style="background-color: #f9f9f9;">
      ...
      data.customerPhone ? `<tr style="background-color: #f9f9f9;">
    ...
    const referralSection = data.referralSources && data.referralSources.length > 0 ? `
